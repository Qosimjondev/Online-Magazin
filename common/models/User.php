 ...
 * @property string $password_hash1
...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function setPassword($password, $password1)
    {
        ...
        $this->password_hash1 = Yii::$app->security->generatePasswordHash($password1);
    }
    ...
    public function isUser(){
        if($this->type == User::USER || $this->type == User::ADMIN){
            return true;
        }
        return false;
    }
    ...
    public function getStatus(){
        if ($this->status == User::STATUS_ACTIVE){
            ...
            return "<span style='font-size: 12px;' class='label label-warning'>O'chirilgan</span>";
        }
    }
}
